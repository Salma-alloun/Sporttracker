...
var UserService = function () {
    ...
    var UserService = _classThis = /** @class */ (function () {
        ...
        UserService_1.prototype.calculateAge = function (birthDate) {
            var today = new Date();
        ...
        UserService_1.prototype.create = function (createUserDto) {
            return __awaiter(this, void 0, void 0, function () {
                var existingUser, salt, hashedPassword, age, user, savedUser;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            ...
                            user = this.userRepository.create(__assign(__assign({}, createUserDto), { password: hashedPassword, age: age }));
                            return [4 /*yield*/, this.userRepository.save(user)];
                        case 4:
                            savedUser = _a.sent();
                            return [2 /*return*/, new user_response_dto_1.UserResponseDto(savedUser)];
                    }
                });
            });
        };
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            users = _a.sent();
                            return [2 /*return*/, users.map(function (user) { return new user_response_dto_1.UserResponseDto(user); })];
                    }
                });
            });
        };
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, new user_response_dto_1.UserResponseDto(user)];
                    }
                });
            });
        };
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            if (!updateUserDto.password) return [3 /*break*/, 4];
                            return [4 /*yield*/, bcrypt.genSalt(10)];
                        case 2:
                            salt = _b.sent();
                            _a = updateUserDto;
                        ...
                        case 3:
                            ...
                            _b.label = 4;
                        case 4:
                            // ✅ Si birthDate est mise à jour, recalculer l'âge
        ...
        UserService_1.prototype.updateStats = function (userId, distance, duration, calories) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
